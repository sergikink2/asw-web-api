...
<body>
	...
	<div class="tres">
		...
		<div>
            <h4> Comments </h4>
            <div>
								<form action="/updatecomment" method="POST" id="formcomment">
									<p id="commentowner" name="commentowner"> {{.commentname}} </p>
									<input id="content" name="content" value={{.commentdescription}}>
